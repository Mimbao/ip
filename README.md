# SkyNET project template

This is the starter project for SkyNET, a command-line chatbot. The sections below explain how to set up and run it.
...
1. Locate `src/main/java/SkyNET.java`, right-click it, and select `Run SkyNET.main()`.
